                    ...
                    <div class="swiper-wrapper" aria-label="carousel">
                        ...
                        <div class="swiper-slide" aria-label="carousel">
                            <div class="slider-caption">
                                <h1>FAQ</h1>
                                <div class="desc">
                                    <p>Are you interested in the new home construction process? 
                                        Looking for the reasonably priced home of your dreams? 
                                        Maybe you need to know more about our EnergiZer0 features, 
                                        our convenient Accessory Dwelling Unit options, or the Hometown Collection in general. 
                                        Whatever it might be, you can find the answers 
                                        by exploring our frequently asked questions below!   
                                    </p>
                                </div>
                            </div>
                        </div>
